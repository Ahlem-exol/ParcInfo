...
type:string ="decharge";
 ...
 idEmp:number;typeMach:string;marqueMach:string;numAlrim:number;
 constructor(private httpClient: HttpClient,private route: ActivatedRoute,private router: Router,private employeeService:EmployeeService ) { }
    ...
    this.documentDefinition = {
      ...
      content: [
        ...
        },
        {
          ...
          text: 'Je soussigné Mr/Mme/Melle : '+thisRef.loadedEmployee.nom+' '+thisRef.loadedEmployee.prenom+'',
        ...
        },
        {
          ...
          text: 
            'Déclare avoir reçu le matériel suivant : ',
        },
       {
 ...
 
      {
        ...
        fontSize:13, bold:true, alignment:'right',
      },
